...
const Featured = () => {
  const sliders = [
    ...
    {
      url: "https://res.cloudinary.com/dcw7yb1jv/image/upload/v1706792400/samples/breakfast.jpg",
    },
    {
      url: "https://res.cloudinary.com/ehizeex-shop/image/upload/v1672672612/NetflixApp/ric_a4ewxo.jpg",
    },
    {
      url: "https://res.cloudinary.com/dcw7yb1jv/image/upload/v1706792374/samples/food/pot-mussels.jpg",
    },
  ];
  ...
  const nextSlider = () => {
    const isNextSlide = currentIndex === sliders.length - 1;
